...
public:
	...
	bool JoinRoom(nim::NIMVideoChatMode mode, const std::string& room_name, const std::string& session_id, const std::string &rtmp_url, bool bypass_rtmp, nim::VChat::Opt2Callback cb);
	//多人音视频
	...
	void SetUidAsMainPicture(const std::string& uid, nim::VChat::Opt2Callback cb);
public:
