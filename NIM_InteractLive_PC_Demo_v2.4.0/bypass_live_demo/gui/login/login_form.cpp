...
#include "chatroom/gui/bypass_live_frontpage.h"
#include "chatroom/gui/chatroom_form.h"
...
// 	};
	...
	nim_ui::OnShowMainWindow cb_show_chatroom = [this] {
		nim_ui::WindowsManager::SingletonShow<nim_chatroom::BypassLiveFontPage>(nim_chatroom::BypassLiveFontPage::kClassName);
// 		if (0)
// 		{
// 			nim_chatroom::ChatroomForm* chat_form = new nim_chatroom::ChatroomForm(1);
// 			chat_form->Create(NULL, nim_chatroom::ChatroomForm::kClassName, WS_OVERLAPPEDWINDOW & ~WS_MAXIMIZEBOX, 0, false);
// 			chat_form->CenterWindow();
// 			chat_form->ShowWindow();
// 		} 
// 		else
// 		{
// 			nim_chatroom::ChatroomFrontpage::InvokeGetMyRoomInfo();
// 		}
	};
