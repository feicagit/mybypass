...
//	static const char *kSdkNimDll = "nim_d.dll";
	...
	if (config.use_private_server_)
	{
		...
		srv_config[nim::kNIMDownloadAddressTemplate] = config.default_nos_download_address_;
...
// 			srv_config[nim::kNIMDefaultNosAccessAddress].append(*iter);
	...
	std::string config_str = GetJsonStringWithNoStyled(config_root);
		//"{ \"app_key\":\"61cd04963d610da059f30cb2968b6756\",\"global_config\" : {\"animated_image_thumbnail_enabled\":false,\"client_antispam\" : false,\"db_encrypt_key\" : \"Netease\",\"https_enabled\" : false,\"login_retry_max_times\" : 0,\"preload_attach\" : true,\"preload_image_quality\" : -1,\"preload_image_resize\" : \"\",\"sdk_log_level\" : 5,\"sync_session_ack\" : true,\"team_msg_ack\" : false,\"team_notification_unread_count\" : false},\"private_server_setting\" : {\"lbs\":\"http://223.252.220.223/lbs/conf\",\"link\" : \"http://223.252.220.223/lbs/conf\",\"module\" : \"\",\"nos_accelerate\" : \"\",\"nos_accelerate_host\" : \"\",\"nos_downloader\" : \"http://nos.netease.com\",\"nos_lbs\" : \"http://wanproxy.127.net/lbs?version=1.0\",\"nos_uploader\" : \"http://223.252.196.40\",\"nos_uploader_host\" : \"\",\"nt_server\" : \"\",\"version\" : 0} }";
	return NIM_SDK_GET_FUNC(nim_client_init)(app_data_dir.c_str(), app_install_dir.c_str(), config_str.c_str());
}
