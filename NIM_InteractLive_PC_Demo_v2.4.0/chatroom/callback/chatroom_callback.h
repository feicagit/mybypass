...
public:
	...
	*/
	...
	static void  UIReceiveSysmsgCallback(nim::SysMessage& msg);
...
private:
	static void RejectInteractionRequest(int style, string nick, string room_id, string sender_id_, string receiver_id_);
};
